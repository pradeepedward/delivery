...
class FastfoodFoodManagement extends Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
        ...
        return (
            <React.Fragment>
                ...
                <br />
                    <Row>
                            <Col md="3">
                                <a href = "/add-Food-Fastfood">
                                    <Card body className="text-center">
                                    <div><i style = {{color : "#343a40", fontSize: "60px", padding: "10px", cursor: "pointer"}} className="fas fa-hamburger"></i></div>
                                        <Button color = "dark">Add Food for Fastfood</Button>
                                    </Card>
                                </a>
                            </Col>
                            <Col md="3">
                                <a href = "/food-Fastfood-List">
                                    <Card body className="text-center">
                                    <div><i style = {{color : "#343a40", fontSize: "60px", padding: "10px", cursor: "pointer"}} className="fas fa-hamburger"></i></div>
                                        <Button color = "dark">Food List</Button>
                                    </Card>
                                </a>
                            </Col>
                        </Row>
...
export default FastfoodFoodManagement;

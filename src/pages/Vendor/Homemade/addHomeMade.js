...
class AddHomemade extends Component {
    constructor(props) {
        super(props);
        this.state = { 
            restaurantName: '',
            ...
            <React.Fragment>
                <div className="page-content">
                    <Container fluid={true}>
                        ...
                        <Breadcrumbs title="Homemade" breadcrumbItem="Add Homemade Vendor" />
                <Row>
                    <Col>
                        <Card>
                        <CardBody>
                        ...
                        <Button color="primary" onClick = {this.handleSubmit.bind(this)} type="submit">Submit</Button>
											...
											>
												Homemade Vendor Successfully Added!
											</SweetAlert>
										) : null}

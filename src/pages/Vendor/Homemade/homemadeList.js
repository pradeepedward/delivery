...
class HomemadeList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            firebaseData: [],
    ...
    delete(key) {
        if (window.confirm('Are you sure you want to delete the homemade vendor?')) {
            ...
            <React.Fragment>
                <div className="page-content">
                    <div className="container-fluid">
                        ...
                        <Breadcrumbs title="Homemade" breadcrumbItem="Homemade List" />
                        ...
                        <Button color="primary" onClick = {this.handleSubmit.bind(this)} type="submit">Update</Button>
											...
											>
												Homemade Vendor Updated Successfully!
											</SweetAlert>
										) : null}
                                        </div>

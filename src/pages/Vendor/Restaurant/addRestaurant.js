...
class AddRestaurant extends Component {
    ...
    handleSubmit(e) {
        ...
        if(data.openTime === '') {
            alert("Enter Restaurant Open Time");
            document.getElementById("openTime").focus();
            return;
        }

        if(data.closeTime === '') {
            alert("Enter Restaurant Close Time");
        ...
        //     firebase.firestore().collection("CategoryIdentity").doc("FastFood").get().then((querySnapshot) => {
        //         ff = querySnapshot.data().entity
        //     })
        ...
        //         firebase.firestore().collection('Vendor').doc("FF"+ff).set({
        ...
        //         var ref = firebase.firestore().collection('CategoryIdentity').doc('FastFood');
        //         ref.update({
        ...
        // }  else if(data.category === "Restaurant") {
            ...
            firebase.firestore().collection("CategoryIdentity").doc("Restaurant").get().then((querySnapshot) => {
                re = querySnapshot.data().entity
            })
            ...
            setTimeout(
                ...
                firebase.firestore().collection('Vendor').doc("RE"+re).set({
                    Name: data.restaurantName,
                    Email: data.email,
                    MobileNumber: data.mobileNumber,
                    Category: "Restaurant",
                ...
                var ref = firebase.firestore().collection('CategoryIdentity').doc('Restaurant');
                ref.update({
                    entity: firebase.firestore.FieldValue.increment(1)
                });
        ...
        // } else if(data.category === "Homemade") {
        //     let hm = 0

        //     firebase.firestore().collection("CategoryIdentity").doc("Homemade").get().then((querySnapshot) => {
        //         hm = querySnapshot.data().entity
        //     })
        ...
        //         firebase.firestore().collection('Vendor').doc("HM"+hm).set({
        //             Name: data.restaurantName,
        //             Email: data.email,
        //             MobileNumber: data.mobileNumber,
        //             Category: data.category,
        ...
        //         var ref = firebase.firestore().collection('CategoryIdentity').doc('Homemade');
        //         ref.update({
        //             entity: firebase.firestore.FieldValue.increment(1)
        //         });
            ...
            <React.Fragment>
                <div className="page-content">
                    <Container fluid={true}>
                        ...
                        <Breadcrumbs title="Restaurant" breadcrumbItem="Add Restaurant" />
                <Row>
                    <Col>
                        <Card>
                        <CardBody>
                        ...
                        <Row>
                            <Col md="4">
                                <FormGroup>
                                    <Label htmlFor="validationCustom03">Restaurant Name<span style = {{color: "red"}}>*</span></Label>
                                    <Input
                                      name="restaurantName"
                        ...
                        <Row>
                            ...
                            <Col md="4">
                                <FormGroup>
                                    <Label htmlFor="validationCustom05">Restaurant Open Time<span style = {{color: "red"}}>*</span></Label>
                                    <Input
                                        name="openTime"
                            ...
                            <Col md= "4">
                                <FormGroup>
                                    <Label htmlFor="validationCustom05">Restaurant Close Time<span style = {{color: "red"}}>*</span></Label>
                                    <Input
                                        name="closeTime"
                        ...
                        <Col md = "8">
                            <FormGroup>
                                <Label htmlFor="validationCustom05">Restaurant Image<span style = {{color: "red"}}>*</span></Label>
                                <Input
                        ...
                        <Button color="primary" onClick = {this.handleSubmit.bind(this)} type="submit">Submit</Button>
											...
											>
												Restaurant Vendor Successfully Added!
											</SweetAlert>
										) : null}

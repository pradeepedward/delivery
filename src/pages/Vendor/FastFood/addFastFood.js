...
class AddFastFood extends Component {
    constructor(props) {
        super(props);
        this.state = { 
            restaurantName: '',
    ...
    restaurantUpload = e =>{
       ...
       const ref = firebase.storage().ref("/FastFood/");
            ...
            <React.Fragment>
                <div className="page-content">
                    <Container fluid={true}>
                        ...
                        <Breadcrumbs title="FastFood" breadcrumbItem="Add FastFood Vendor" />
                <Row>
                    <Col>
                        <Card>
                        <CardBody>
                        ...
                        <Button color="primary" onClick = {this.handleSubmit.bind(this)} type="submit">Submit</Button>
											...
											>
												FastFood Vendor Successfully Added!
											</SweetAlert>
										) : null}

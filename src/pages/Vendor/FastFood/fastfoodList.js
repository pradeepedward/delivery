...
class FastFoodList extends Component {
    ...
    delete(key) {
        if (window.confirm('Are you sure you want to delete the fastfood vendor?')) {
            ...
            <React.Fragment>
                <div className="page-content">
                    <div className="container-fluid">
                        ...
                        <Breadcrumbs title="FastFood" breadcrumbItem="FastFood List" />
                        ...
                        <Button color="primary" onClick = {this.handleSubmit.bind(this)} type="submit">Update</Button>
											...
											>
												FastFood Vendor Updated Successfully!
											</SweetAlert>
										) : null}
                                        </div>

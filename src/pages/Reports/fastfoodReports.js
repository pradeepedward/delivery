...
class FastFoodReport extends Component {
    constructor(props) {
        super(props);
        this.state = {
            firebaseData: []
            ...
            <React.Fragment>
                <div className="page-content">
                    <div className="container-fluid">
                        ...
                        <Breadcrumbs title="Reports" breadcrumbItem="FastFood Vendor Report" />
                        <Row>
                            <Col lg={12}>
                                <Card>
                                    <CardBody>

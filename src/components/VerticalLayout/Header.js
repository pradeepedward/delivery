...
import yummyLogo from "../../assets/images/yummy_logo.png";
import yummySmLogo from "../../assets/images/yummy_sm_logo.png";
        ...
        <header id="page-topbar">
          <div className="navbar-header">
            <div className="d-flex">
              <div className="navbar-brand-box" style = {{backgroundColor: "#fff"}}>
                <Link to="/" className="logo logo-dark">
                  {/* <span className="logo-sm">
                    <img src={logo} alt="" height="22" />
                  </span> */}
                  <span className="logo-lg">
                    <img src={yummyLogo} alt="" height="50" />
                  </span>
                </Link>

                <Link to="/" className="logo logo-light">
                  <span className="logo-sm">
                    <img src={yummySmLogo} alt="" height="22" />
                  </span>
                  <span className="logo-lg">
                    <img src={yummyLogo} alt="" height="50" />
                  </span>
